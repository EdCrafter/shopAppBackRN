...
Post.create(title: 'second post',
            body: 'The data can then be loaded with the bin/rails db:seed command (or created alongside the database with db:setup).')
Post.create(title: 'ALRIGHT', body: 'testy boi')